  ...
  constructor(
    ...
    if (this.myBtn) {
      ...
      this.renderer.listen(this.myBtn, 'mouseover', () => {
        this.renderer.setStyle(this.myBtn, 'background-color', this.isDisabled ? 'rgba(0, 0, 0, 0.2)' : 'rgb(93, 0, 241)');
        this.renderer.addClass(this.myBtn, this.isDisabled ? 'not-allowed' : '');
      })
